...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonSpinner, IonLabel, IonAccordion, IonItem, IonIcon, IonAccordionGroup, IonListHeader, IonList } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonList, IonListHeader, IonAccordionGroup, IonIcon, IonItem, IonAccordion, IonLabel, IonSpinner, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
