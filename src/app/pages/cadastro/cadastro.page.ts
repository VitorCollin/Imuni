...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButton, IonItem, IonInput, AlertController } from '@ionic/angular/standalone';
  ...
  async aoCadastrar(){
    if(this.cadastroForm.valid){
      ...
      try{
        ...
        await this.exibirAlerta('Sucesso', 'A conta de responsável foi criada com sucesso. Seja bem-vindo ao Imuni!')
        this.router.navigate(["/login"]);
      }catch(erro: any){
        console.log('Erro ao fazer o cadastro', erro);
        let mensagemErro = 'Não foi possivel realizar o cadastro. Tente novamente.!';
